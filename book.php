...
<div class="bookcard-wrapper ">
      ...
      <div class="book-wrapper">
            <div class="desc-wrapper">
             <img src = "userimg/<?php echo $row['image']; ?>" alt="profile">
            </div>
      ...
      <div class="bio-wrapper">
        <div class = "info">
            <p>Note : Car is already booked for following date:</p>
            <div class = "date">
            <?php 
            $available = $mysqli->query("SELECT * FROM booking WHERE car_id = '$id'");
        ...
        <div class = "form-wrapper">
         ...
         <div class = "input">
            ...
            <input type = "text" id = "rate"  style = "display:none" value = "<?php echo $row['rate'] ?>">
            ...
            <input style = "border: none; background:none; box-shadow: none;" type = "text" name = "days" id = "day" onkeyup = "validate()" required = "required">
            </div>
            <div class = "input">
  ...
  <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
    ...
    var Difference_In_Days = Difference_In_Time / (1000 * 3600 * 24); 
        if(Difference_In_Days < 1){
            ...
            input.textContent  = Difference_In_Days * rate ;
            msg.innerHTML = "";
            btn.disabled = false;
            btn.style.cursor = 'pointer';
            btn.style.backgroundColor = 'rgb(144, 105, 235)'; 
